...
class fire_t:
    ...
    def make_random_obstacle(self):
        ...
        if value == 'I':
            ...
            for i in range(2):
                self.obstacle.append([])
                for j in range(3):
                    block = Block(i, j, GREEN, self.block_size, type="L")
                    if (i == 1 and j == 0):
                        block.color = WHITE
                    self.obstacle[i].append(block)
        elif value == 'J':
            for i in range(2):
                self.obstacle.append([])
                for j in range(3):
                    block = Block(i, j, GREEN, self.block_size, type="J")
                    if (i == 1 and j == 2):
                        block.color = WHITE
                    self.obstacle[i].append(block)
        elif value == 'Z':
            for i in range(2):
                self.obstacle.append([])
                for j in range(3):
                    block = Block(i, j, GREEN, self.block_size, type="Z")
                    if (i == 1 and j == 2) or (i == 0 and j == 0):
                        block.color = WHITE
                    self.obstacle[i].append(block)
        elif value == 'S':
            for i in range(2):
                self.obstacle.append([])
                for j in range(3):
                    block = Block(i, j, GREEN, self.block_size, type="S")
            ...
            for i in range(2):
                self.obstacle.append([])
                for j in range(3):
                    block = Block(i, j, GREEN, self.block_size, type="T")
                    if (i == 0 and j == 1):
                        block.color = WHITE
                    self.obstacle[i].append(block)
    ...
    def fight_fire(self):
        parameters = []
        pygame.display.set_caption('Fire Truck')
